...
(function(window, document, $, undefined) {
  ...
  $('[data-load-css]').on('click', function(e) {
	...
	if(Cookies.get('theme-url-css')){
		$('[data-load-css]').each(function(index, value){
			if($(this).attr('data-load-css') == Cookies.get('theme-url-css')){
				$(this).find('input[name=setting-theme]').prop('checked',true);
			} else {
				$(this).find('input[name=setting-theme]').prop('checked',false);
			}
		});
	}
  ...
  // ----------------------------------------
	...
	$('input[name=layoutMode]').on('click', function() {
		...
		Cookies.set('layout-mode', getVal);
	});
  
	if(Cookies.get('layout-mode')){
		$('input[name=layoutMode]').each(function(index, value){
			if($(this).val() == Cookies.get('layout-mode')){
