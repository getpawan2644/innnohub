...
<?php $__env->startSection('header',"Edit Feature"); ?>

<?php $__env->startSection('breadcrumb'); ?>
    ##parent-placeholder-6e5ce570b4af9c70279294e1a958333ab1037c86##
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.features.index',$user->id)); ?>">Manage Feature</a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?php echo e(route('admin.features.update',$record->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                               ...
                               <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                          ...
                                          <label class="control-label float-left">Tilte</label>
                                          <input type="hidden" class="form-control" name="user_id" value='<?php echo e(old('user_id',$data->user_id)); ?>'>
                                         
                                          <input type="text" class="form-control" name="title" placeholder="Tilte" value='<?php echo e(old('title',$data->title)); ?>'>
                            ...
                            <a href="<?php echo e(route('admin.features.index',$user->id)); ?>" class="btn btn-accent btn-outline mt-4">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/features/edit.blade.php ENDPATH**/ ?>