        ...
        <div class="container sml-container">
            <div class="row">
                <div class="col-lg-6">
                    <!-- about us image -->
                    <div class="about-img">
                        <img src="<?php echo e(asset('image/about.png')); ?>" alt="about image" class="img-fluid">
                    </div>
                    <!-- about us image end -->
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <!-- vision -->
                    <div class="vision">
                        <img src="<?php echo e(asset('image/v-1.png')); ?>" alt="icon">
                ...
                <div class="col-lg-6">
                    <!-- vision -->
                    <div class="vision">
                        <img src="<?php echo e(asset('image/v-2.png')); ?>" alt="icon">
                        <div class="vison-cont">
                            <h6>Mission</h6>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/cms/cms_page.blade.php ENDPATH**/ ?>