...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.gallery.index',$user->id)); ?>">Manage galaries </a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?php echo e(route('admin.gallery.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                                                ...
                                                                <input type="file" class="form-control" name="image" placeholder="" value='<?php echo e(old('image')); ?>'>
...
<?php echo $__env->make('layouts.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/multimedia/create.blade.php ENDPATH**/ ?>