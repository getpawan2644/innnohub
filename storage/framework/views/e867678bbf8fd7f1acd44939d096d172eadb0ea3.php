						...
						<div class="row m-0">
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-a.css')); ?>">
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-b.css')); ?>">
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-c.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-dark"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-d.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-dark"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-e.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-dark"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-f.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-dark"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-g.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-dark"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-h.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-dark"></span>
						...
						<div class="row m-0">
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-i.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-j.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-light"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-k.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-light"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-l.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-light"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-m.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-light"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-n.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-light"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-o.css')); ?>">
										<input type="radio" name="setting-theme">
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-light"></span>
							...
							<div class="col-6 col-md-3 p-5 m-b-10">
								<div class="color-option-check">
									...
									<label data-load-css="<?php echo e(asset('css/admin/layouts/vertical/themes/theme-p.css')); ?>">
										<input type="radio" name="setting-theme" />
										<span class="icon-check"></span>
										<span class="split">
											<span class="color bg-menu-light"></span>
...
<!-- END SIDEBAR QUICK PANNEL WRAPPER --><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/elements/layouts/right.blade.php ENDPATH**/ ?>