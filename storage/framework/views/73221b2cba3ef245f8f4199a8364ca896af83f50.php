...
<?php $__env->startSection('header',"Edit Testimonials"); ?>

<?php $__env->startSection('breadcrumb'); ?>
    ##parent-placeholder-6e5ce570b4af9c70279294e1a958333ab1037c86##
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.testimonials.index',$user->id)); ?>">Manage Testimonials </a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?php echo e(route('admin.testimonials.update',$record->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                               ...
                               <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                  ...
                                  <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                          ...
                                          <textarea class="form-control"  rows="5" name="comment"><?php echo e(old('description',$data->comment)); ?></textarea>
...
<?php echo $__env->make('layouts.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/testimonials/edit.blade.php ENDPATH**/ ?>