...
<?php $__env->startSection('header',"Edit Gallery"); ?>

<?php $__env->startSection('breadcrumb'); ?>
    ##parent-placeholder-6e5ce570b4af9c70279294e1a958333ab1037c86##
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.gallery.index',$user->id)); ?>">Manage Gallery</a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?php echo e(route('admin.gallery.update',$record->id)); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                  ...
                                  <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                          ...
                                          <img id="blah" src="<?php echo e(asset($data->imageurl)); ?>" alt="your image"style="cursor:pointer;width: 112px;"/>
                            ...
                            <a href="<?php echo e(route('admin.gallery.index',$user->id)); ?>" class="btn btn-accent btn-outline mt-4">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/multimedia/edit.blade.php ENDPATH**/ ?>