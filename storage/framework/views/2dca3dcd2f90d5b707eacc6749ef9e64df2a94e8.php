<?php $__env->startSection('title',"Manage Features"); ?>

<?php $__env->startSection('header',"Manage Features"); ?>
...
<section class="page-content container-fluid">
    <div class="row">
		<div class="col-lg-12 text-right" style="line-height:0;">
			<a href="<?php echo e(route('admin.features.add',['user_id'=>$user_id])); ?>" class="btn btn-primary add_btn_top" style="margin-top:-85px">Add Awards </a>
		</div>
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body card_table_body">
					...
					<div class="table-responsive">
                      ...
                      <td align="center">
                        <a href="#" class="border-btn open-Addview" class="action_btn"  data-name="<?php echo e($record->title); ?>"  data-description="<?php echo e($record->description); ?>"  data-toggle="modal" data-target="#make_offer_model1"><i class="icofont-eye" data-toggle="tooltip" data-placement="top" title="View" style="font-size: 20px;"></i></a>
                        <a href="<?php echo e(route('admin.features.edit',['user_id'=>$user_id, 'id'=>$record->id])); ?>" class="action_btn"><i class="icofont-edit" data-toggle="tooltip" data-placement="top" title="Edit" style="font-size: 17px;"></i></a>
                        <!--a href="<?php echo e(URL('services/delete/'.$record->id)); ?>" class="action_btn"><i class="la la-pencil"></i> Delete</a-->
                        <a href="javascript:void(0);" class="action_btn confirmDelete" data-action="<?php echo e(route('admin.features.delete',$record->id)); ?>"><i class="icofont-delete" data-toggle="tooltip" data-placement="top" title="Delete" style="font-size: 17px;"></i></a>
...
<?php echo $__env->make('layouts.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/features/index.blade.php ENDPATH**/ ?>