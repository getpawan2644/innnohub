...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.casestudy.index',$user->id)); ?>">Manage Case Study </a></li>
    <li class="breadcrumb-item active" aria-current="page">Add casestudy</li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="<?php echo e(url("admin/case-study/store")); ?>" enctype="multipart/form-data">
                                                    <?php echo csrf_field(); ?>
                            ...
                            <a href="<?php echo e(route('admin.casestudy.index',$user->id)); ?>" class="btn btn-accent btn-outline mt-4">Cancel</a>
                                                </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/casestudies/create.blade.php ENDPATH**/ ?>