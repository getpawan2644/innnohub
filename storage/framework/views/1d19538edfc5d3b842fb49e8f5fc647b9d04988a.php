	...
	<section class="page-content container-fluid">
	    <div class="row">
	        <div class="col-12 grid-margin stretch-card">
	            <div class="card">
	                <div class="card-body">
	                    <form class="forms-sample" method="POST" action="<?php echo e(route('admin.users.update',$record->id)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="country_code" name="country_code" value="<?php echo e((old('country_code', $record->country_code))?old('country_code', $record->country_code):'qa'); ?>">
                                        <input type="hidden" id="dial_code" name="dial_code" value="<?php echo e((old('dial_code', $record->dial_code))?old('dial_code', $record->dial_code):'974'); ?>">
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password" placeholder="Enter user password" value='<?php echo e(old('password')); ?>'>
	                    ...
	                    <button type="submit" class="btn btn-primary mr-2 mt-4">Update</button>
                        	<a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-accent btn-outline mt-4">Cancel</a>
	                    </form>
	                </div>
	            </div>
	        </div>
...
<?php echo $__env->make('layouts.admin.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp 2\htdocs\innohub\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>