            ...
            <div class="card">
                <div class="card-body card_table_body">
					<div class="card-header">
						<div class="col-lg-6">	
											<form action="{{URL('case-study')}}" method="GET">
									...
									@foreach($records as $record)
										<tr>
											...
											<td align="center">
												...
												<a href="{{URL('case-study/edit/'.$record->id)}}" class="action_btn"><i class="icofont-edit" data-toggle="tooltip" data-placement="top" title="Edit" style="font-size: 17px;"></i></a>
												<!--a href="{{URL('services/delete/'.$record->id)}}" class="action_btn"><i class="la la-pencil"></i> Delete</a-->
												<a href="javascript:void(0);" class="action_btn confirmDelete" data-action="{{ route('casestudy.delete',$record->id) }}"><i class="icofont-delete" data-toggle="tooltip" data-placement="top" title="Delete" style="font-size: 17px;"></i></a>
