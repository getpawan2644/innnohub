...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.appointment.index') }}">Manage Appointment </a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{route('admin.appointment.store')}}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="card card-border-primary language_card">
                                <div class="card-header text-left">Add Appointment Date And Time</div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <label class="control-label float-left">Select Date</label>
                                                <input type="text" class="form-control" name="date" id="appointment-date" placeholder="Select Date From Dropdown" value="{{old('date')}}">
                                            </div>
                                            @if ($errors->has('date'))
                                    ...
                                    <div class="appointment-div">
                                        ...
                                        @else
                                            <div class="row appointment">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-xs-5 col-sm-5 to">
                                                    <div class="form-group">
                                                        <select class="form-control to-time" name="to_time[]">
                            ...
                            <button type="submit" class="btn btn-primary mr-2 mt-4 form-sbmt-btn">Add</button>
    ...
    $(function() {
        ...
        $(document).ready(function(){
            $(".from-time").change(function(){
                // console.log($(this).closest(".row.appointment").children(".to").children(".form-group").children(".to-time").val());
                // let date=$("#appointment-date").val();
                //
                // console.log($(this).closest(".row.appointment").find(".to-time").val());
                // new Date(date)
            });
        });
