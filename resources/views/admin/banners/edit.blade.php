    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.banners.update',$record->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control banner_position" name="banner_position" readonly value="{{$record->banner_position}}">
                                    ...
                                    <div class="form-check top_banner {{(old("banner_position",$record->banner_position)==Banner::TOP_BANNER)?'':'hide'}} button_fields">
                            ...
                            <div class="row button_checked {{(old("have_button",$record->have_button))?'':'hide'}} top_banner button_fields">
                                        ...
                                        <div class="row button_checked {{(old("have_button",$record->have_button))?'':'hide'}} top_banner button_fields">
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" onkeyup="rtl(this);" name="{{ $locale }}[button_label]" dir="{{CommonHelper::getAlignment($locale)}}" placeholder="Enter the button label" value='{{ old($locale.'.button_label', $record->translateOrNew($locale)->button_label) }}'>
                                        ...
                                        <div class="row top_banner {{(old("banner_position",$record->banner_position)==Banner::TOP_BANNER)?'':'hide'}}">
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" onkeyup="rtl(this);" name="{{ $locale }}[title]" dir="{{CommonHelper::getAlignment($locale)}}" placeholder="Enter the title" value='{{ old($locale.'.title', $record->translateOrNew($locale)->title) }}'>
...
{{--                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">--}}
{{--                                                <div class="form-group">--}}
{{--                                                    <label class="control-label float-{{CommonHelper::getTextAlign($locale)}}">{{$language}} Banner Heading</label>--}}
{{--                                                    <input type="text" class="form-control" onkeyup="rtl(this);" name="{{ $locale }}[heading]" dir="{{CommonHelper::getAlignment($locale)}}" placeholder="Enter heading of banner" value='{{ old($locale.'.heading', $record->translateOrNew($locale)->heading) }}'>--}}
