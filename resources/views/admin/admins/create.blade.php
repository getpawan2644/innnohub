...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.cms.index') }}">Manage Admin </a></li>
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" id="phone" name="phone" class="form-control"
                                               value="{{ old('phone', $record->mobile) }}"
                                               placeholder="Please enter phone number">
                                        <input type="hidden" id="country_code" name="country_code"
                                               value="{{ (old('country_code', $record->country_code))?old('country_code', $record->country_code):'qa' }}">
                                        <input type="hidden" id="dial_code" name="dial_code"
                                               value="{{(old('dial_code', $record->dial_code))?old('dial_code', $record->dial_code):'974'}}">
                                        <script>
                                ...
                                <div class="col-lg-12 col-md12 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email"
                                               placeholder="Enter User Email" value="{{ old('email',$record->email) }}">
                                        @if ($errors->has('email'))
                                            <span class="error-message">
                                            ...
                                            <div class="checkbox_container">
                                                ...
                                                <label>
                                                    <input class="{{($checkbox_key=="Full Admin Access")?"admin_check":"view_check"}}" type="checkbox"
                                                           name="modules[]"
                                                           value="{{$value}}"@php if(in_array($value,old("modules",array())) || (empty(old('modules')) && $checkbox_key=="View Only")){ echo "checked";}@endphp {{($value=="disabled")?"disabled":""}}>
