    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.cms.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group md-3">
                                                        ...
                                                        <input type="text" class="form-control" onkeyup="rtl(this);" name="{{ $locale }}[url]" dir="{{CommonHelper::getAlignment($locale)}}" placeholder="Enter the title" value='{{ old($locale.'.url', $record->translateOrNew($locale)->url) }}'>
                                                    </div>
