                ...
                <div class="card">
                    <div class="card-body card_table_body">
                        ...
                        <div style="float:right;margin: -25px 18px 15px 0px;">
                            ...
                            <a href="{{route("admin.products-status.normal-csv")}}" class="btn btn-primary mt-2"><i class="la la-file-excel-o" style="font-size:26px;"></i>Normal Export</a>
                        </div>
                        <div style="float:right;margin: -25px 18px 15px 0px;">
                            <label style="display: block;margin-bottom: 0;">&nbsp;</label>
                            <a href="{{route("admin.products-status.image-csv")}}" class="btn btn-primary mt-2"><i class="la la-file-excel-o" style="font-size:26px;"></i>Image Export</a>
                        </div>
                        <div style="float:right;margin: -25px 18px 15px 0px;">
                            <label style="display: block;margin-bottom: 0;">&nbsp;</label>
                            <a href="{{route("admin.products-status.analytics.csv")}}" class="btn btn-primary mt-2"><i class="la la-file-excel-o" style="font-size:26px;"></i>Product Analytics Export</a>
                        </div>
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="align_center">Discount(%)</th>
                                    <th class="align_center">@sortablelink('display_discount', 'Discount Status')</th>
...
{{--                                            <td class="align_center">{{ number_format(@$record->price,0) }}</td>--}}
                                            <td class="align_center">{{ @$record->discount_percent }}</td>
                                            <td align="center" class="align_center">{!! CommonHelper::changeTrendingSale('admin.products.display_discount',$record->display_discount,$record->id) !!}</td>
