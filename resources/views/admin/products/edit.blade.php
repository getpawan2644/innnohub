@php
    ...
    $subcategories = \App\Models\SubCategory::getSubCategory(old("category_slug",$record->category_slug));
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.products.update',$record->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" onkeyup="rtl(this);" name="{{ $locale }}[product_title]" dir="{{CommonHelper::getAlignment($locale)}}" placeholder="Enter Product Title" value="{{ old($locale.'.product_title', $record->translateOrNew($locale)->product_title) }}">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="product-details-{{$locale}}" rows="20" placeholder="Enter Details" class="form-control" name="{{$locale}}[product_details]">{{ old($locale.'.product_details', $record->translateOrNew($locale)->product_details) }}</textarea>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="product-description-{{$locale}}" rows="20" placeholder="Enter Details" class="form-control" name="{{$locale}}[product_description]">{{ old($locale.'.product_description', $record->translateOrNew($locale)->product_description) }}</textarea>
                            ...
                            <div class="card card-border-primary">
                                <div class="card-header text-left">Image and Video<div class="" style="float: right"><button class="btn primary-btn">Reorder</button></div></div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <div class="form-group select-photo">
                                                ...
                                                @if(!empty(old('product_img',$record->product_img)))
														...
														@foreach($oldImages['images'] as $imgKey => $imgValue)
															<li class="mr-5 paidImage" id="{{@$imgValue['id']}}">
                                                        ...
                                                        @if(!empty($record['ProductImage']))
                                                            @foreach($record['ProductImage'] as $imgKey=>$imgValue)
                                                                <li class="mr-5 paidImage" id="{{$imgValue['id']}}">
                                                                    <div class="coustom-input">
                                                                        <a href="javascript:void(0);" class="remove-edit-pic"
                                                                           image_id="{{$imgValue['id']}}">X</a>
                                                                        <img
                                                                            src="{{asset('files/productImg/'.$imgValue['product_id'].'/'.$imgValue['thumbnail'])}}"/>
                                                                        <input type="hidden" class="images_input"
                                                                               name="product_img[image_id][]"
                                                                               value="{{$imgValue['id']}}"/>
                                                                        <input type="hidden" class="images_input"
                                                                               name="product_img[images][]"
                                                                               value="{{$imgValue['image']}}"/>
                                                                        <input type="hidden" class="images_url"
                                                                               name="product_img[images_url][]"
                                                                               value="{{asset('files/productImg/'.$imgValue['product_id'].'/'.$imgValue['image'])}}"/>
                                                                        <input type="hidden"
                                                                               class="thumbnail_images_input"
                                                                               name="product_img[thumbnail][]"
                                                                               value="{{$imgValue['thumbnail']}}"/>
                                                                        <input type="hidden" class="thumbnail_url"
                                                                               name="product_img[thumbnail_url][]"
                                                                               value="{{asset('files/productImg/'.$imgValue['proproduct_idperty_id'].'/'.$imgValue['thumbnail'])}}"/>
                                                                    </div>
                                                                    <div class="image-title upload">&nbsp;</div>
                                                                </li>
                                                            @endforeach
                                                    ...
                                                    <li class="green-photo mr-3">
                                                        <div class="coustom-input">
                                                            <input type="file" class="property-edit-image custom-file-input">
                                                        </div>
