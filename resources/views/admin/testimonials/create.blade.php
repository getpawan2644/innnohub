...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.testimonials.index',$user->id) }}">Manage Testimonial </a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{url("admin/testimonials/store")}}" enctype="multipart/form-data">
                                                    @csrf
