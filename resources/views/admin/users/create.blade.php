...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.categories.index') }}">Manage Users </a></li>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        @endif
{{--                                        <input type="text" class="@error('first_name') is-invalid @enderror" name="first_name" placeholder="Enter user first name" value=''>--}}
{{--                                        @error('first_name')--}}
                                ...
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="control-label">Phone Number</label>
                                            <input type="hidden" id="country_code" name="country_code" value="{{ (old('country_code', $record->country_code))?old('country_code', $record->country_code):'in' }}">
                                            <input type="hidden" id="dial_code" name="dial_code" value="{{(old('dial_code', $record->dial_code))?old('dial_code', $record->dial_code):'91'}}">
