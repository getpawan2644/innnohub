...
@section('header',"Add Privacy Policy")

@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.faqs.index') }}">Manage Privacy Policies </a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.privacy_policies.store') }}" enctype="multipart/form-data">
                            @csrf
