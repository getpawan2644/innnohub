...
@section('title',"Add Term & Condition")

@section('header',"Add Term & Condition")

@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.faqs.index') }}">Manage Terms & Conditions </a></li>
    <li class="breadcrumb-item active" aria-current="page">Add Term & Condition</li>
@endsection
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.term_conditions.store') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="{{ $locale }}[title]" dir="{{CommonHelper::getAlignment($locale)}}" placeholder="Enter Term & Condition title" value={{ old($locale.'.title', $record->translateOrNew($locale)->title) }}>
                            ...
                            <a href="{{ route('admin.term_conditions.index') }}" class="btn btn-accent btn-outline mt-4">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
