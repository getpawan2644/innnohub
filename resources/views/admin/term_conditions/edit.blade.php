...
@section('header',"Edit Terms & Conditions")

@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.term_conditions.index') }}">Manage Policies </a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.term_conditions.update',$record->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
