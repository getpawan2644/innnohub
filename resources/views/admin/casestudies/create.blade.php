...
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item"><a href="{{ route('admin.casestudy.index',$user->id) }}">Manage Case Study </a></li>
    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{url("admin/case-study/store")}}" enctype="multipart/form-data">
                                                    @csrf
...
{{--                                                    </div>--}}
                            ...
                            <a href="{{ route('admin.casestudy.index',$user->id) }}" class="btn btn-accent btn-outline mt-4">Cancel</a>
                                                </form>
                    </div>
                </div>
            </div>
