    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.vendors.update',$record->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="hidden" class="form-control" id="country_hidden_input"name="country_code" value='{{ old("country_code", $record->country_code) }}'>
                                        </div>
                                        @if ($errors->has('code'))
                                            <span class="error-message">
...
<script>
    jQuery(document).ready(function(){
        ...
        $("#country_select").change(function(){
            ...
            $("#country_hidden_input").val($('option:selected', this).attr('country_code'));
        });
