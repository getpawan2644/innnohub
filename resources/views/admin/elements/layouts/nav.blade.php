		...
		<li>
			<a href="{{ route('admin.dashboard.index') }}">
				<div class="logo_mobile">
					<!-- <img id="logo_mobile"  width="30" height="30" src="{{ asset('img/admin/logo2x.png') }}" /> -->Topvestor
				</div>
	...
	<ul class="navbar-nav nav-right">
		...
		<li class="nav-item dropdown">
			<a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
				<img src="{{ Auth::guard('admin')->user()->profile_pic_url }}" class="w-35 rounded-circle" alt="Albert Einstein">
			</a>
			<div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
				<div class="dropdown-header pb-3">
					<div class="media d-user">
						<img class="align-self-center mr-3 w-40 rounded-circle" src="{{ Auth::guard('admin')->user()->profile_pic_url }}" alt="Albert Einstein">
				...
				<a class="dropdown-item" href="{{ route('admin.showProfileForm') }}">
					<i class="icon dripicons-user"></i> Profile
				</a>
				<div class="dropdown-divider"></div>
				<a class="dropdown-item" href="{{ route('admin.showPasswordForm') }}">
