    ...
    <section class="page-content container-fluid">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('admin.features.update',$record->id) }}" enctype="multipart/form-data">
                            @csrf
                               ...
                               <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12 mt-3">
                                      {{-- <div class="form-group"> --}}
                                          ...
                                          <input type="text" class="form-control" name="title" placeholder="Tilte" value='{{ old('title',$data->title) }}'>
