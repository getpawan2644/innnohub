...
class MultimediaController extends Controller
{
    ...
    {
         $records = Multimedia::where('user_id',$user_id)->with('userData')->sortable(['id' => 'desc']);
       ...
       $records = $records->paginate(($request->query('limit') ? $request->query('limit'):env('PAGINATION_LIMIT') ));
        return view('admin.multimedia.index',compact(['records','user_id']));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function add($user_id, Multimedia $multimedia)
    {
        $user = \App\Models\User::findOrFail($user_id);
        return view('admin.multimedia.create',compact('user','multimedia'));
    }
    ...
    public function store(MultimediaRequest $MultimediaRequest,Multimedia $Multimedia)
    {
      // print_r($ServicesRequest->all()); die;
        ...
        try{
			...
			DB::commit();
            return redirect('admin/gallery')->with(['title'=>__('messages.success'),'success'=>'Multimedia Added Successfully']);
		} catch(\Exception $e){
    ...
    public function edit($user_id, $id)
    {
        ...
        $record = Multimedia::where('id',$id)->with('userData')->findOrFail($id);
        $user = \App\Models\User::findOrFail($user_id);
       return view('admin.multimedia.edit',compact('record','user','data'));
    ...
    public function update(MultimediaRequest $MultimediaRequest, $id)
    {
     ...
     /*  }else{
         ...
         return redirect('admin/gallery')->with(['title'=>__('messages.success'),'success'=>'Multimedia Updated Successfully']);
