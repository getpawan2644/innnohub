...
class CasestudyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('casestudies.index',compact('records'));
    }
    ...
    public function store(CasestudyRequest $CasestudyRequest,CaseStudy $CaseStudy)
    {
      // print_r($ServicesRequest->all()); die;
        ...
        try{
			...
			DB::commit();
            return redirect('case-study')->with(['title'=>__('messages.success'),'success'=>'Case Study Added Successfully']);
		} catch(\Exception $e){
       ...
       //print_R($ServicesRequest->all()); die;
        ...
        if(!empty($id)){
           ...
           $data=CaseStudy::where('id',$id)->update(['name'=>$CasestudyRequest->name,'description'=>$CasestudyRequest->description]);
            return redirect('case-study')->with(['title'=>__('messages.success'),'success'=>'Case Study Updated Successfully']);
